    ...
    <div className="projects-holder">
      ...
      {isInfo[0] && (
        <ul>
          ...
          <li>
            Having the team options include filters to decide wich kind of team
            would you like for that current charter
          </li>
          <li>
            Possiblity of allowing the auto import which charters you own insted
            of manually adding them
          </li>
          <li>
            Possiblity of adding weapons and which artifact set to use with the
            charters
          </li>
          <li>
